      ...
      <main className="hidden md:block flex-grow pt-24 pb-20 px-4 sm:px-8 lg:px-16 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="font-sans text-xs sm:text-sm text-stone-600 font-light max-w-xl leading-relaxed">
            Explore our curated beauty and grooming treatments in Ramalloor, Ernakulam, tailored specifically for men and women.
          </p>
        ...
        {/* Overview Section: 3x2 Category Grid */}
        {activeTab === 'all' && (
          <div className="mb-20">
                ...
                >
                  <div>
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        <h2 className="font-sans font-bold text-base sm:text-lg tracking-wider text-[#1F1F1F] uppercase leading-tight mt-1">
                          {category.title}
                        </h2>
                      </div>
                    </div>
