...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/assets/fade_haircut.png`, text: '' },
      { image: `/assets/facial.png`, text: '' },
      { image: `/assets/grooming.png`, text: '' },
      { image: `/assets/hair treatment.png`, text: '' },
      { image: `/assets/waxing.png`, text: '' },
      { image: `/assets/manicure.png`, text: '' }
    ];
