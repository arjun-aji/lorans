      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="md:col-span-7 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="w-16 h-[1.5px] bg-[#c59842] mb-8" aria-hidden="true" />
            ...
            <span
              className="font-signature text-4xl text-[#c59842] mt-6 mb-12 block select-none"
          ...
          {/* Right Column: High-End Salon Imagery */}
          <div className="md:col-span-5 w-full">
            <div className="relative h-[280px] sm:h-[380px] lg:h-[460px] w-full overflow-hidden shadow-xl rounded-sm group">
              <Image
                src="/assets/about1.png"
                alt="Luxurious styling stations at Loran's Gents Beauty & Make Up Studio Ramalloor featuring leather chairs and premium backlighting"
